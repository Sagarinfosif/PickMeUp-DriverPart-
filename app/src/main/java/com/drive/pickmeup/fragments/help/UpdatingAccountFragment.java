...
public class UpdatingAccountFragment extends Fragment implements View.OnClickListener {
    ...
    public UpdatingAccountFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_updating_account, container, false);
        ids();
        setup();
        feedback();
        return view;
    ...
    private void setup() {
        ...
        tv_text_title.setText(bundle.getString("account_info"));
