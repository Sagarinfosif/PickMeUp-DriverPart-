...
public class UploadingDocumentFragment extends Fragment implements View.OnClickListener {
    ...
    public UploadingDocumentFragment() {
    ...
    private void setup() {
        ...
        tv_text_title.setText(bundle.getString("upload_document"));
